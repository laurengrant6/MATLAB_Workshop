...
% Screen('DrawTexture', windowPtr, Image11, [],up_left_destrect);

% Screen('DrawTexture', windowPtr, Image11, [],up_right_destrect);

% Screen('DrawTexture', windowPtr, Image11, [],down_destrect);

% Screen('DrawTexture', windowPtr, Image11, [],down_left_destrect);

% Screen('DrawTexture', windowPtr, Image11 , [],down_right_destrect);
