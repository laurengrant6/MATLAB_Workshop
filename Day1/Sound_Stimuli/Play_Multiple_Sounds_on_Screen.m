...
[sample_sound1 soundfreq] = audioread(strcat(Pathway,'sample_sound2.wav'));
[sample_sound2 soundfreq] = audioread(strcat(Pathway,'sample_sound3.wav'));
...
PsychPortAudio('FillBuffer', pahandle, sample_sound2');
